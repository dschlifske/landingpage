      ...
      >
        ...
        >
          ...
          <Text
            ...
            padding="0px 0px 0px 0px"
            whiteSpace="pre-wrap"
            children="Siloed and CD-ROM centric medical imaging is leading to suboptimal health outcomes. We offer a digital, patient-driven network to help users store their medical images, find the right specialist, and receive seamless second opinions."
            {...getOverrideProps(
              overrides,
